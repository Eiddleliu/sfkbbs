...
<div id="top">
	...
	<ul class="nav">
		<li><a href="#" target="_blank">传游社</a></li>
	</ul>
	...
	<ul>
		...
		<li><!--  class="current" -->
			...
			<ul class="child">
				...
				?>
                <li><a <?php if(basename($_SERVER['SCRIPT_NAME'])=='message.php'){echo 'class="current"';}?> href="message.php">资讯列表</a></li>
                <li><a <?php if(basename($_SERVER['SCRIPT_NAME'])=='message_add.php'){echo 'class="current"';}?> href="message_add.php">添加资讯</a></li>
                <?php
                if(basename($_SERVER['SCRIPT_NAME'])=='message_update.php'){
                    echo '<li><a class="current">编辑资讯</a></li>';
                }
                ?>
		...
		<li>
			...
			<ul class="child">
                <li><a <?php if(basename($_SERVER['SCRIPT_NAME'])=='layfolk.php.php'){echo 'class="current"';}?> href="layfolk.php">用户列表</a></li>
			</ul>
		</li>
	</ul>
</div>