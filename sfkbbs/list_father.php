...
$template['css']=array('style/public.css','style/list.css','style/style.css');
?>
	...
	<div id="left">
		<div class="box_wrap">
			...
			<div class="pages_wrap">
				...
				<div class="pages">
					<?php 
					$page=page($count_all,10);//控制分页个数（每10个分一页）
					echo $page['html'];
					?>
				</div>
...
<!--                    进入个人主页-->
				...
				<div class="subject">
					<div class="titleWrap"><a href="list_son.php?id=<?php echo $data_content['ssm_id']?>">[<?php echo $data_content['module_name']?>]</a>&nbsp;&nbsp;<h2><a  href="show.php?id=<?php echo $data_content['id']?>"><?php echo $data_content['title']?></a></h2></div>
					<p>
